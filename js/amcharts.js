...
(function() {
    ...
    d.AxisBase = d.Class({
        ...
        parseDatesDraw: function() {
            ...
            q = this.firstTime;
            var C = 0;
            a && 1 < x && (u = this.chooseMinorFrequency(x), w = d.getPeriodDuration(v, u));
            if (0 < this.gridCountR)
                for (a = k; a <= B; a++) {
                    ...
                    m = l = p;
                    if (!isNaN(u))
                        for (h = 1; h < x; h += u) this.gridAlpha = this.minorGridAlpha, f = p + w * h, f = d.resetDateToMin(new Date(f), v, u, r).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth), this.pushAxisItem(f);
                    this.gridAlpha = z
                }
        },
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            if ("H" == Pa) {
                ...
                0 <= b && b <= V + 1 && (0 < B && 0 < A && b + l <= V + 1 && (ca = d.line(z, [0, B], [b + l, b + l], v, A, C), w.push(ca)), 0 < D && (ta = d.line(z, [0, qa, sa + qa], [b, b + ja, b + ja], I, D, C, H), w.push(ta)));
                ia = "end";
    ...
    d.AmGraph = d.Class({
        ...
        createSerialGraph: function() {
            ...
            for (K = da; K <= pa; K++) {
                ...
                if (Ba) {
                    ...
                    if (!xb && X < ma || xb && X < ta) y.isNegative = !0, Ja && (Ia = Ja), Xa && (Sa = Xa), void 0 != Ca && (Aa = Ca);
                    Ya = !1;
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                k.push(m.path);
                void 0 !== t && (n = new d.Bezier(g, a, b, t, x, n, r, 0, h), d.setCN(f, n, this.bcn + "stroke"), d.setCN(f, n, this.bcn + "stroke-negative"), l.push(n.path));
                ...
                if (r) {
                    ...
                    if (c.mouseIsOver || B || D || this.forceShow)
                        if (this.forceShow = !1, D) {
                            ...
                            x = this.line;
                            0 < this.cursorAlpha && (u ? (v = 0, z = t + l, e && (z -= g.cellWidth / 2)) : (v = t, z = 0, e && (v -= g.cellWidth / 2)), A = this.animationDuration, 0 < A && !this.zooming ? isNaN(this.previousX) ? x.translate(v, z) : (x.translate(this.previousX, this.previousY), x.animate({
                                translate: v + "," + z
                            ...
                            z = !0;
                            B && (z = !1);
                            this.categoryBalloonEnabled && z ? (this.setBalloonPosition(w, g, t, u), (x = this.categoryBalloonFunction) ? w.showBalloon(x(r.category)) : g.parseDates ? (g = d.formatDate(r.category, this.categoryBalloonDateFormat, c), -1 != g.indexOf("fff") && (g = d.formatMilliseconds(g, r.category)), w.showBalloon(g)) : w.showBalloon(d.fixNewLines(r.category))) : w.hide();
...
(function() {
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p) {
        ...
        0 < l && (J = " M" + z + "," + (x + l) + " L" + v + "," + (A + l), u ? (O || (J += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + v + "," + (A + l) + "," + B + "," + (D + l)), J += " L" + C + "," + (w + l), 0 < k && (O || (J += " B" + (b - k) + "," + (l + c - t) + "," + (b + k) + "," + (l + c + t) + "," + C + "," + (l + w) + "," + z + "," + (l + x)))) : (J += " A" + f + "," + g + ",0," + H + ",1," + B + "," + (D + l) + " L" + C + "," + (w + l), 0 < k && (J += " A" + k + "," + t + ",0," + H + ",0," + z + "," + (x + l))), J = a.path(J + " Z", void 0, void 0, "1000,1000").attr(I), e.push(J), J = a.path(" M" + z + "," + x + " L" + z + "," + (x + l) + " L" + v + "," + (A + l) + " L" + v + "," + A + " L" + z + "," + x + " Z", void 0, void 0, "1000,1000").attr(I), l = a.path(" M" + B + "," + D + " L" + B + "," + (D + l) + " L" + C + "," + (w + l) + " L" + C + "," + w + " L" + B + "," + D + " Z", void 0, void 0, "1000,1000").attr(I), e.push(J), e.push(l));
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (v = 0; v < w.length; v++) {
                ...
                H + x.width > q && 0 < v && 0 !== A && (r++, A = 0, H = f, B = H + x.width + f + n, D = D + C + m, C = 0);
                I.translate(H, D);
                A++;
